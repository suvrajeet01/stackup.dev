...
const senderKeys: KeyInfo = {
  address: "X-fuji1l9yw0n5zwrjzurqa8yl8dfypd2lq0txw68rufj",
  publicKey: "52FZn21ujnaZJWd8n8WqvozZWtTCLSbTeV3jYT5fD3fMgTRZ3x",
  privateKey: "PrivateKey-2fdNv2pWHFnWLRZPR7qwANgUqvK2N9bSPgNBU8s8w96zaqaBH2",
};
const assetID = "2bDXz3xgd7h1LPu66Vf3bYVPLAj54LmJTRkmTnKf9aFdfH599L"; // the transaction ID is used as asset ID
const friendsAddress = "X-fuji1kczlwqgqewswgqcy94vw7yvkmp7nyxn0kctlu7"; // address format is Bech32
// ============ Main Part of Script ===================
